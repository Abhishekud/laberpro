...
namespace LaborPro.Automation.Features.Standards
{
    ...
    public class StandardsSteps
    {
        ...
        public void SelectCreatedStandard(string standaradByName)
        {
            ...
            StandardsPage.SelectStandard(standaradByName);
        ...
        [Given(@"User verify add button is not available on standard page")]
        [When(@"User verify add button is not available on standard page")]
        ...
        [Given(@"User verify edit button is not available on standard details page")]
        [When(@"User verify edit button is not available on standard details page")]
        ...
        [Given(@"User verify export option is available on standard page")]
        [When(@"User verify export option is available on standard page")]
        ...
        [Given(@"User verify download report option is available")]
        [When(@"User verify download report option is available")]
        [Then(@"User verify download report option is available")]
        public void VerifyDownloadReportOptionIsAvailable()
        {
        ...
        [Given(@"User verify add button is not available for standard element on standard details page")]
        [When(@"User verify add button is not available for standard element on standard details page")]
        [Then(@"User verify add button is not available for standard element on standard details page")]
        public void VerifyAddButtonIsNotAvailableForStandardElement()
        {
        ...
        [Given(@"User verify add option is not available for standard group on standard details page")]
        [When(@"User verify add option is not available for standard group on standard details page")]
        [Then(@"User verify add option is not available for standard group on standard details page")]
        public void VerifyAddOptionIsNotAvailableForStandardGroup()
        {
        ...
        [Given(@"User verify tick option in existing standard element is not available")]
        [When(@"User verify tick option in existing standard element is not available")]
        [Then(@"User verify tick option in existing standard element is not available")]
        public void VerifyAddOptionInExistingStandardElementIsNotAvailable()
        {
        ...
        [Given(@"User selects standard in standard listing")]
        [When(@"User selects standard in standard listing")]
        [Then(@"User selects standard in standard listing")]
