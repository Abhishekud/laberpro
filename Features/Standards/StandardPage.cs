...
namespace laborpro.Features.Standards
{
    public class StandardPage
    {
        ...
        public static void AddStandardsWihGivenInput(Table inputData)
        {
            ...
            {
                WebDriverUtil.WaitForWebElementInvisible(STANDARD_FORM, WebDriverUtil.TEN_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
            }
        ...
        public static void AddStandardElementwithGivenInput(Table inputData)
        {
            ...
            {
                WebDriverUtil.WaitForWebElementInvisible(NEW_STANDARD_ELEMENT_FORM, WebDriverUtil.TEN_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
            }
