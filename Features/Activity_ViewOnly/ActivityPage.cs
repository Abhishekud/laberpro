...
namespace LaborPro.Automation.Features.Activity_ViewOnly
{
    public class ActivityPage
    {
        ...
        public static void DeleteActivityIfExist(string activityName)
        {
            ...
            IWebElement record = WebDriverUtil.GetWebElementAndScroll(activityRecordXpath, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
            if (record != null)
            {
        ...
        public static void CloseActivityDetailSideBar()
        {
            ...
            IWebElement activityDetailsSideBar = WebDriverUtil.GetWebElement(CloseActivityDetails, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void DeleteCreatedActivity(string activityName)
        {
           ...
           $"Unable to locate Activity record on Activity page - {activityRecordXpath}").Click();
            ...
            IWebElement confirmationPopup = WebDriverUtil.GetWebElement(ActivityDeleteConfirmPopup, WebDriverUtil.TWO_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void VerifyDeleteButtonIsNotPresent(string activityName)
        {
            ...
            var activityRecordXpath = string.Format(ActivityRecord, activityName);
            WebDriverUtil.GetWebElement(activityRecordXpath, WebDriverUtil.ONE_SECOND_WAIT,
            $"Unable to locate Activity record on Activity page - {activityRecordXpath}" ).Click();
            IWebElement deleteButton = WebDriverUtil.GetWebElement(AddButton, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void AddNewActivityWithGivenInput(Table inputData)
        {
            ...
            if (WebDriverUtil.GetWebElement(ActivityPopup, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE) != null)
            {
        ...
        public static void CloseActivityForm()
        {
            ...
            WaitForActivityAlertCloseIfAny();
            IWebElement formCloseButton = WebDriverUtil.GetWebElement(CloseActivityFormButton, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
