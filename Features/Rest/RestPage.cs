...
namespace LaborPro.Automation.Features.Rest
{
    public class RestPage
    {
        ...
        private const string RestDeleteConfirmPopupAccept = "//*[@class='modal-dialog']//button[text()='Confirm']";
        private const string RestPopup = " //*[@role='dialog']//*[@class='modal-title' and contains(text(), 'New Rest')]";
