...
namespace LaborPro.Automation.Features.UnitOfMeasure
{
    public class UnitsOfMeasurePage
    {
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.VerifyAddButtonIsNotAvailable");
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.VerifyDeleteButtonIsNotAvailable");
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.VerifyExportOptionIsNotAvailable");
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.ClickOnUnitOfMeasure");
            WebDriverUtil.GetWebElement(ListManagementDropdown, WebDriverUtil.NO_WAIT,
                $"Unable to locate list management dropdown - {ListManagementDropdown}").Click();
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.DeleteUnitOfMeasureIfExist");
            var uomRecord = string.Format(UomRecord, unitOfMeasureName);
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.AddNewUnitOfMeasureWithGivenInputIfNotExist");
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.DeleteCreatedUnitOfMeasureByName");
            var uomRecord = string.Format(UomRecord, unitOfMeasureName);

            WebDriverUtil.GetWebElement(uomRecord, WebDriverUtil.ONE_SECOND_WAIT,
            $"Unable to locate UnitOfMeasure record on UnitOfMeasures page - {uomRecord}").Click();

            WebDriverUtil.GetWebElement(DeleteButton, WebDriverUtil.ONE_SECOND_WAIT,
                $"Unable to locate delete button - {DeleteButton}").Click();

            WebDriverUtil.GetWebElement(ConfirmButton, WebDriverUtil.TWO_SECOND_WAIT,
                $"Unable to locate confirm button - {ConfirmButton}").Click();
            ...
            if (formAlert == null)
            {
                WebDriverUtil.WaitForWebElementInvisible(UomConfirmPopup, WebDriverUtil.PERFORM_ACTION_TIMEOUT,
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.SelectCreatedDepartment");
        ...
        public static void AddUnitOfMeasureWihGivenInput(Table inputData)
        {
            ...
            if (formAlert == null)
            {
                WebDriverUtil.WaitForWebElementInvisible(UnitsOfMeasurePopup, WebDriverUtil.PERFORM_ACTION_TIMEOUT,
                    "Timeout - " + WebDriverUtil.PERFORM_ACTION_TIMEOUT + " Sec. Application taking too long time to perform operation");
            }
            else
            {
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.VerifyCreatedUnitOfMeasure");
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.DeleteCreatedUnitOfMeasure");
            WebDriverUtil.GetWebElement(DeleteButton, WebDriverUtil.ONE_SECOND_WAIT,
                $"Unable to locate delete button - {DeleteButton}").Click();
            WebDriverUtil.GetWebElement(ConfirmButton, WebDriverUtil.TWO_SECOND_WAIT,
                $"Unable to locate confirm button - {ConfirmButton}").Click();
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.VerifyRecordOfSelectedDept");
        ...
        {
            LogWriter.WriteLog("Executing UnitsOfMeasurePage.DeleteUnitOfMeasureByName");
            ...
            if (WebDriverUtil.GetWebElement(UnitOfMeasurePage, WebDriverUtil.ONE_SECOND_WAIT, WebDriverUtil.NO_MESSAGE) != null)
            {
                ...
                $"Unable to locate UnitOfMeasure on UnitsOfMeasure page - {unitsOfMeasures}"
                ).Click();
                WebDriverUtil.WaitFor(WebDriverUtil.ONE_SECOND_WAIT);
            }
