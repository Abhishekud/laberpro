...
namespace LaborPro.Automation.Features.UnitOfMeasure
{
    public class UnitsOfMeasurePage
    {
        ...
        private const string EditFormCloseButton = "//*[@class='controlled-actions']//button[contains(text(),'Close')]";
        ...
        public static void DeleteCreatedUnitOfMeasureByName(string unitOfMeasureName)
        {
            ...
            {
                throw new Exception($"Unable to delete UnitOfMeasure Error - {alert.Text}");
            }
        }
        ...
        public static void CloseUomEditForm()
        {
            ...
            WebDriverUtil.GetWebElement(EditFormCloseButton,
                WebDriverUtil.NO_WAIT,
                $"Unable to locate close button in edit form - {EditFormCloseButton}").Click();
        }
        ...
        public static void VerifyRecordOfSelectedDept(string message)
        {
            ...
            if (WebDriverUtil.GetWebElement(UnitOfMeasurePage, WebDriverUtil.TWO_SECOND_WAIT,
                    $"Unable to locate the UnitsOfMeasure page - {UnitOfMeasurePage}") == null) return;
