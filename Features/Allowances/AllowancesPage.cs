...
namespace laborpro.pages
{
    public class AllowancesPage
    {
        ...
        const string FORM_INPUT_FIEND_ERROR_XPATH = "//*[contains(@class,'validation-error')]";
        ...
        const string ALLOWANCE_POPUP = "//*[@role='dialog']//*[@class='modal-title' and contains(text(), 'New Allowance')]";
        ...
        public static void VerifyAddAllowanceErrorMessage(string message)
        {
            ...
            IWebElement errorMessage = WebDriverUtil.GetWebElementAndScroll(FORM_INPUT_FIEND_ERROR_XPATH, WebDriverUtil.ONE_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void AddAllowanceWithGivenInput(Table inputData)
        {
            ...
            if (Util.ReadKey(dictionary, "Rest Calculation") != null)
            {
                ...
                String.Format("Unable to locate Rest Calculation input on create allowance page - {0}", RESTCALCULATION_INPUT)))
                    .SelectByValue(dictionary["Rest Calculation"]);
            }
            ...
            {
                WebDriverUtil.WaitForWebElementInvisible(ALLOWANCE_POPUP, WebDriverUtil.DEFAULT_WAIT, WebDriverUtil.NO_MESSAGE);
            }
        ...
        public static void DeleteAllowance()
        {
            ...
            SeleniumDriver.Driver().FindElement(By.XPath(ALLOWANCE_DETAILS_MENU_BUTTON)).Click();
            SeleniumDriver.Driver().FindElement(By.XPath(ALLOWANCE_EDIT_LINK)).Click();
            SeleniumDriver.Driver().FindElement(By.XPath(ALLOWANCE_DELETE_BUTTON)).Click();
            SeleniumDriver.Driver().FindElement(By.XPath(ALLOWANCE_DELETE_CONFIRM_POPUP_ACCEPT)).Click();
            WebDriverUtil.WaitForWebElementInvisible(ALLOWANCE_DELETE_CONFIRM_POPUP, WebDriverUtil.DEFAULT_WAIT, WebDriverUtil.NO_MESSAGE);
        }
