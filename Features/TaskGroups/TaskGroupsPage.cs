...
namespace LaborPro.Automation.Features.TaskGroups
{
    public class TaskGroupsPage
    {
        ...
        {
            LogWriter.WriteLog("Executing TaskGroupsPage.AddNewTaskGroupsWithGivenInputIfNotExist");
        ...
        private static void CloseTaskGroupsDetailSideBar()
        {
        ...
        public static void DeleteCreatedTaskGroups(string taskGroupsName)
        {
            ...
            WebDriverUtil.GetWebElement(TaskGroupsDeleteButton, WebDriverUtil.TWO_SECOND_WAIT,
            $"Unable to locate TaskGroups delete button on TaskGroups details page - {TaskGroupsDeleteButton}").Click();
        ...
        public static void VerifyCreatedTaskGroups(string taskGroupsName)
        {
            ...
            $"Unable to locate record on TaskGroups page - {taskGroupRecordXpath}");
            BaseClass._AttachScreenshot.Value = true;

        }
        public static void VerifyAddMenuPopup()
        {
            LogWriter.WriteLog("Executing TaskGroupsPage.VerifyAddMenuPopup");
            WebDriverUtil.GetWebElement(TaskGroupsPopup, WebDriverUtil.NO_WAIT, $"Unable to locate add menu popup - {TaskGroupsPopup}");
            BaseClass._AttachScreenshot.Value = true;
        ...
        public static void AddNewTaskGroupsWithGivenInput(Table inputData)
        {
            ...
            if (Util.ReadKey(dictionary, "Name") != null)
            {
                ...
                $"Unable to locate Name input on create TaskGroups page  - {NameInput}")
            ...
            if (Util.ReadKey(dictionary, "Generic Department") != null)
            {
                ...
                $"Unable to locate Generic Department input on create TaskGroups page - {GenericDeptInput}")
        ...
        public static void UserClickOnNewTaskGroupsMenuLink()
        {
            ...
            $"Unable to locate new TaskGroups menu link on add menu popup - {AddTaskGroupsLink}").Click();
        ...
        public static void ClickOnAddButton()
        {
            ...
            $"Unable to locate add button on TaskGroups page  - {AddButton}").Click();
