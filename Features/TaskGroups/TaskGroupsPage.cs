...
namespace LaborPro.Automation.Features.TaskGroups
{
    public class TaskGroupsPage
    {
        ...
        public static void VerifyAddMenuPopup()
        {
            ...
            WebDriverUtil.GetWebElement(TaskGroupsPopup, WebDriverUtil.NO_WAIT, $"Unable to locate AddMenuPopup");
            BaseClass._AttachScreenshot.Value = true;
        ...
        public static void UserClickOnNewTaskGroupsMenuLink()
        {
            ...
            $"Unable to locate New TaskGroupsMenu menu link on add menu popup - {AddTaskGroupsLink}").Click();
