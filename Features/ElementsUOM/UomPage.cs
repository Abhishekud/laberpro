...
namespace LaborPro.Automation.Features.ElementsUOM
{
    public class UomPage
    {
        ...
        public static void DeleteUomIfExist(string uomName)
        {
            ...
            var record = WebDriverUtil.GetWebElementAndScroll(uomRecordXpath, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
            if (record != null)
            {
        ...
        public static void ClickOnListManagementTab()
        {
            ...
            if (WebDriverUtil.GetWebElement(ListManagementPage, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE) !=
                null) return;
        ...
        public static void CloseUomDetailSideBar()
        {
            ...
            var uomDetailsSideBar = WebDriverUtil.GetWebElement(CloseUomDetails, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
            ...
            if (uomDetailsSideBar == null) return;
            uomDetailsSideBar.Click();
            WebDriverUtil.WaitFor(WebDriverUtil.ONE_SECOND_WAIT);
        }
        ...
        public static void DeleteCreatedUom(string uomName)
        {
            ...
            var confirmationPopup = WebDriverUtil.GetWebElement(UomDeleteConfirmPopup, WebDriverUtil.TWO_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void VerifyDeleteButtonIsNotPresent(string uomName)
        {
            ...
            var deleteButton = WebDriverUtil.GetWebElement(UomDeleteButton, WebDriverUtil.ONE_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void AddNewUomWithGivenInput(Table inputData)
        {
            ...
            if (WebDriverUtil.GetWebElement(UomPopup, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE) == null) return;
        ...
        public static void CloseUomForm()
        {
            ...
            WaitForUomAlertCloseIfAny();
            var formCloseButton = WebDriverUtil.GetWebElement(CloseUomFormButton, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void AddNewUomIfNotExist(Table inputData)
        {
            var dictionary = Util.ConvertToDictionary(inputData);
            ...
            if (record == null)
            {
                AddNewUomWithGivenInput(inputData);
            }
            else
            {
                record.Click();
