...
namespace LaborPro.Automation.Features.VolumeDriverMapping
{
    public class VolumeDriverMappingPage
    {
        ...
        public static void VerifyEditVolumeDriverMappingSidebarIsAvailable(string volumeDriverMapping)
        {
            ...
            WebDriverUtil.GetWebElement(volumeDriverRecord, WebDriverUtil.NO_WAIT, $"Unable to locate volume driver mapping record on volume driver mapping page - {volumeDriverRecord}").Click();
            WebDriverUtil.WaitForAWhile();
            var editVolumeDriverMappingSidebar = WebDriverUtil.GetWebElement(EditVolumeDriverMappingSidebar, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
        ...
        public static void VerifyVolumeDriverMappingListingEditOptionIsNotAvailable()
        {
            ...
            var editVolumeDriverMappingSetButton = WebDriverUtil.GetWebElement(EditVolumeDriverMappingSetButton, WebDriverUtil.ONE_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
