...
namespace LaborPro.Automation.Features.Department
{
    public class DepartmentsPage
    {
        ...
        public static void AddNewDepartmentWithGivenInputIfNotExist(Table inputData)
        {
            ...
            var departmentRecord = string.Format(DepartmentRecord, dictionary["Name"]);
        ...
        public static void VerifyDeleteButtonIsNotPresent(string departmentName)
        {
            ...
            var delete = WebDriverUtil.GetWebElement(DepartmentDeleteButton, WebDriverUtil.ONE_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
            if (delete != null)
        ...
        public static void DeleteDepartmentIfExist(string departmentName)
        {
            ...
            var departmentRecord = string.Format(DepartmentRecord, departmentName);
            var record = WebDriverUtil.GetWebElementAndScroll(departmentRecord, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
            if (record != null)
            {
