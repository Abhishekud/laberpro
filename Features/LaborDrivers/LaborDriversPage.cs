...
namespace LaborPro.Automation.Features.LaborDrivers
{
    public class LaborDriversPage
    {
        ...
        public static void AddNewLaborDriversWithGivenInputIfNotExist(Table inputData)
        {
            ...
            var laborRecordXpath = string.Format(LaborDriversRecord, dictionary["Name"]);
            var record = WebDriverUtil.GetWebElementAndScroll(laborRecordXpath, WebDriverUtil.NO_WAIT, WebDriverUtil.NO_MESSAGE);
            if (record == null)
            {
        ...
        public static void DeleteCreatedLaborDrivers(string laborDriversName)
        {
            ...
            var laborRecordXpath = string.Format(LaborDriversRecord, laborDriversName);
            WebDriverUtil.GetWebElement(laborRecordXpath, WebDriverUtil.NO_WAIT,
            $"Unable to locate LaborDrivers record on LaborDrivers page - {laborRecordXpath}").Click();

            WebDriverUtil.GetWebElement(LaborDriversDeleteButton, WebDriverUtil.TWO_SECOND_WAIT,
            $"Unable to locate LaborDrivers delete button on LaborDrivers details - {LaborDriversDeleteButton}").Click();
        ...
        public static void VerifyCreatedLaborDrivers(string laborDriversName)
        {
            ...
            var laborRecordXpath = string.Format(LaborDriversRecord, laborDriversName);
            WebDriverUtil.GetWebElement(laborRecordXpath, WebDriverUtil.ONE_SECOND_WAIT,
            $"Unable to locate record LaborDrivers page - {laborRecordXpath}");
            BaseClass._AttachScreenshot.Value = true;
        ...
        {
            LogWriter.WriteLog("Executing LaborDriversPage.VerifyCreatedLaborDrivers");
            WebDriverUtil.GetWebElement(LaborDriversPopup, WebDriverUtil.NO_WAIT, $"Unable to locate AddMenuPopup - {LaborDriversPopup}");
            BaseClass._AttachScreenshot.Value = true;
        ...
        public static void AddNewLaborDriversWithGivenInput(Table inputData)
        {
            ...
            if (Util.ReadKey(dictionary, "Name") != null)
            {
                ...
                $"Unable to locate Name input LaborDrivers page  - {NameInput}")
        ...
        public static void UserClickOnNewLaborDriversMenuLink()
        {
            ...
            $"Unable to locate NewLaborDriversMenu menu link on add menu popup - {AddLaborDriversLink}").Click();
        }
        public static void ClickOnAddButton()
        {
            ...
            $"Unable to locate add button LaborDrivers page  - {AddButton}").Click();
