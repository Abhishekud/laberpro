...
@Setup @Smoke
  ...
  Scenario: 04.Verify_that_Respective_'Volume Driver Mapping Set'_&_'Characteristic Set'_are_available_in_dropdown.
    Given User navigates to the VolumeDriverMapping tab
     ...
     Then User verify created VolumeDriverMappingset by name "VolumeDriverMappingset via LocationMapping"
    ...
    Given User navigates to the VolumeDriver tab
     ...
     Then User verify created VolumeDriver by name "VolumeDriver via LocationMapping"
    ...
    Given User navigates to the VolumeDriverMapping tab
     ...
     Then User verify created VolumeDriverMapping by "VolumeDriver via LocationMapping"
  ...
  @Smoke
  Scenario: 05.Verify_that_Respective_'Volume Driver Mapping Set'_&_'Characteristic Set'_are_available_in_dropdown_is_deleted.
    Given User navigates to the Locations tab
      And User delete created location by name "Location via LocationMapping"
     Then User navigates to the VolumeDriverMapping tab
     When User select the Department "Department to verify LocationMapping"
