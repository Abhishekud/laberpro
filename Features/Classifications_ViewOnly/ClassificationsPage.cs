...
namespace LaborPro.Automation.Features.Classifications
{
    public class ClassificationsPage
    {
        ...
        const string DEPARTMENT_VALUE_IN_LM_DROPDOWN = "//select[@id='standardFilingFieldId']//option[@value='CLASSIFICATIONS']";
        ...
        public static void VerifyCreatedClassifications(string classificationsName)
        {
            ...
            String.Format("Unable to locate record Classificationss page - {0}", String.Format(CLASSIFICATIONS_RECORD, classificationsName)));
            BaseClass._AttachScreenshot.Value = true;
            CloseClassificationsDetailSideBar();
        }
         
        public static void VerifyAddButtonIsNotAccessible()
        {
        ...
        public static void VerifyDeleteButtonIsNotAccessible(string classificationsName)
        {
            ...
            IWebElement Delete = WebDriverUtil.GetWebElement(CLASSIFICATIONS_DELETE_BUTTON, WebDriverUtil.ONE_SECOND_WAIT, WebDriverUtil.NO_MESSAGE);
            if (Delete == null)
            {
                BaseClass._AttachScreenshot.Value = true;
            }
        ...
        public static void AddNewClassificationsWithGivenInput(Table inputData)
        {
            ...
            if (Util.ReadKey(dictionary, "Name") != null)
            {
                ...
                String.Format("Unable to locate Name input Classificationss page  - {0}", NAME_INPUT))
                    .SendKeys(dictionary["Name"]);
            }
            WebDriverUtil.GetWebElementAndScroll(SAVE_BUTTON, WebDriverUtil.NO_WAIT,
                String.Format("Unable to locate save button Classificationss page - {0}", SAVE_BUTTON)).Click();
            WebDriverUtil.WaitFor(WebDriverUtil.ONE_SECOND_WAIT);
        ...
        public static void ClickOnAddButton()
        {
            ...
            String.Format("Unable to locate add button Classificationss page  - {0}", ADD_BUTTON)).Click();
